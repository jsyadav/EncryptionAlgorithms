...
extern "C"
jint
Java_com_example_jyadav_encryptionalgorithms_MainActivity_norx_1crypto_1aead_1encrypt(
        ...
        jbyteArray nsec, jbyteArray npub, jbyteArray k)
{
    ...
    jint i =  norx_crypto_aead_encrypt(
...
extern "C"
jint
Java_com_example_jyadav_encryptionalgorithms_MainActivity_norx_1crypto_1aead_1decrypt(
        ...
        jbyteArray npub, jbyteArray k)
{
    ...
    jint i =  norx_crypto_aead_decrypt(
